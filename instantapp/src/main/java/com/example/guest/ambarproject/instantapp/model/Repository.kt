...
data class Repository(val id: Int, val name: String, val full_name: String, val owner: Owner, val html_url: String, val description: String, val stargazers_url: String, val stars: Int, val forks: Int)
